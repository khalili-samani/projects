...
Forecasts generated by the model should not be used for financial trading or operational decision-making. The primary objective is to demonstrate practical analytics, data engineering and machine learning skills using real-world data.